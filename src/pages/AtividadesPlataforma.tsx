...
const AtividadesPlataforma = () => {
  ...
  const { plataformaStats, plataformaActivities } = useActivitiesData();
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-white">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold">
                Portal Atividades Programadas – (PLATAFORMA)
              </h1>
            </div>
            <LiveClock />
          </div>
      ...
      <main className="container mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-6">
          <EquipmentCard title="Plataforma" count={total} />
        ...
        <div className="space-y-6 mb-6">
          ...
          <Card className="p-6 shadow-card">
            <h2 className="text-lg font-bold text-purple-800 mb-4">
              Total de Atividades e Cancelamentos - Plataforma
            </h2>
